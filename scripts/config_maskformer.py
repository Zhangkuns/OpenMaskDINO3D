...
model = dict(
    ...
    add_loc=True,
    use_loc_add=False,
    #pcd_dir = "D:/Download/thesis/dataset/scannet/ChatScene/mask3d_ins_data/pcd_all",
    #pcd_dir = "/home/zhangkunshen/data/scannet/ChatScene/mask3d_ins_data/pcd_all",
    #pcd_dir = "/home/zks/data/scannet/ChatScene/mask3d_ins_data/pcd_all",
...
wandb = dict(
    ...
    project="Scene-LLM-no-img-token",
...
do_save = True
auto_resume = True
pretrained_path = "./checkpoints/ckpt_01_3446.pth"
img_projector_path = ""
